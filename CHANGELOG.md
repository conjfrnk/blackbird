...
Multi-agent audit (2026-05-10) of the Rust core, Swift session/PTY/renderer, and FFI surface — 25 findings (4 MED CONFIRMED, 4 MED PROBABLE, 7 LOW CONFIRMED, 10 LOW PROBABLE). 20 fixed in 21 commits; 4 skipped as documented design tradeoffs (#04 OSC 8 cache eviction, #05 PID-reuse on missing start-time, #12 osc7_reject_logged latch, #20 TERMINFO env redirect — all already documented as accepted in inline comments); 1 skipped as accepted limitation (#23 mysshwrapper basename allowlist — KNOWN_ISSUES.md updated).
