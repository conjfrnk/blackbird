...
| 0.2 | **Xcode pinned to 16.2 in CI; local dev is Xcode 26.6 / macOS 26.** Every shipped DMG is built against the macOS 15 SDK; Tahoe-specific behaviour (hit-testable hidden NSTabBar, Liquid Glass) is never compiled or tested by CI. ✔ | `ci.yml:112,292,350,446,590`, `release.yml:46`, `README.md:68` | S |  _Done 2026-09-09 (v0.8.1): CI matrixed on macos-15/26; `release.yml` builds on macos-26 / Xcode 26.6, opting into Liquid Glass._
